...
#train_dir = './model/train_block4_fulldata'
dataset_name = 'jdpig'
...
tf.app.flags.DEFINE_string(
    'model_name', 'densenet161', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_integer(
    'resize_side_min', 256, 'Train image size')

tf.app.flags.DEFINE_integer(
    'resize_side_max', 512, 'Train image size')

tf.app.flags.DEFINE_integer(
    'dataset_num', None, 'Train image size')
...
tf.app.flags.DEFINE_string(
    'checkpoint_exclude_scopes', 'global_step,densenet161/logits',
    'Comma-separated list of scopes of variables to exclude when restoring '
    'from a checkpoint.')

tf.app.flags.DEFINE_string(
    'trainable_scopes', 'densenet161/logits,densenet161/dense_block4',
...
def _configure_learning_rate(num_samples_per_epoch, global_step):
  ...
  elif FLAGS.learning_rate_decay_type == 'cos':
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    def clone_fn(batch_queue):
      ...
      '''
      alpha = 0.6
      centor_loss, centers, centers_update_op = _get_center_loss(feature2208[:,0,0,:], non_one_hot_labels, alpha, dataset.num_classes)
      beta = 0.0
      tf.add_to_collection(tf.GraphKeys.LOSSES, beta*centor_loss)
      '''
      return end_points#,centers_update_op
